...
1. 打開你的 GitHub 專案頁面，例如：
   - `https://github.com/<你的帳號>/<repo-name>`
2. 點選上方的 **Settings**。
3. 左側選單找到 **Pages**（有時在「Code and automation」區塊底下）。
4. 在 **Build and deployment** 區塊中：
   - **Source** 選擇 `Deploy from a branch`。
   - **Branch** 選擇 `main`，並保持資料夾為 `/ (root)`。
   - 按 **Save**。
5. 等待數十秒到一兩分鐘，GitHub Pages 會在同一頁顯示：
...
- 修改後建議流程：
  ...
  3. 一般情況下，GitHub Pages 會在 push 之後自動重新部署，稍等片刻即可在網頁上看到最新版本。
